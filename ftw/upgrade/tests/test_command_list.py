...
class TestListCommand(CommandAndInstanceTestCase):
    ...
    def test_listing_profiles(self):
        ...
        with self.package_created():
            ...
            normalized_output = list(
                map(str.strip, re.sub(r" +", " ", output).splitlines())
            )
    ...
    def test_all_sites_argument_json(self):
        ...
        with self.package_created():
            ...
            exitcode, output = self.upgrade_script("list --upgrades --json --all-sites")
    ...
    def test_all_sites_argument_no_json(self):
        ...
        with self.package_created():
            ...
            exitcode, output = self.upgrade_script("list --upgrades --all-sites")
            self.assertEqual(exitcode, 0)
